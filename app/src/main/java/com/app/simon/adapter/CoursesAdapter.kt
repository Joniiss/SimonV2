...
class CoursesAdapter(private val mData: MutableList<SubjectData>, private val user: User, private val student: Boolean) : RecyclerView.Adapter<CoursesAdapter.CoursesViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CoursesViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_course, parent, false)
        return CoursesViewHolder(view, user, student)
    }
    ...
    class CoursesViewHolder(itemView: View, private val user: User, private val student: Boolean) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: SubjectData) {
            ...
            btnAccess.setOnClickListener{
                ...
                iCourse.putExtra("courseName",item.name)
